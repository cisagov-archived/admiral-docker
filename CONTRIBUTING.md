...
issue](https://github.com/cisagov/admiral-docker/issues) in this
...
request](https://github.com/cisagov/admiral-docker/pulls), you will
...
```console
cd admiral-docker
pyenv virtualenv <python_version_to_use> admiral-docker
pyenv local admiral-docker
